...
--set @DateAsOf=GetDate()
 ...
 declare @AOR TABLE 
    ...
    INSERT INTO @AOR (DueDate,LoanId,BorrowerId,LoanAmount,InterestRate,TermsOfPayment,AmountDue,Payment,Balance,
		 ...
		 Select b.FirstName+' '+b.LastName as Name,b.Address,b.ContactInfo, a.AmountDue,a.TermsOfPayment,a.LoanId,(Select Name From Offices WHERE OfficeId =b.OfficeId) as Offices,
