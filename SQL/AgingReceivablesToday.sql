create PROCEDURE [dbo].[AgingReceivablesToday]
AS 
BEGIN
...
set @DateAsOf=GetDate()
 ...
 declare @AOR TABLE 
    ...
    INSERT INTO @AOR (DueDate,LoanId,BorrowerId,LoanAmount,InterestRate,TermsOfPayment,AmountDue,Payment,Balance,
		 ...
		 From @AOR a  INNER JOIN Borrowers b ON a.BorrowerId  =b.BorrowerId  WHERE b.Status =1 and isnull(a.balance,0)>0 and DATEPART(DAY,a.DueDate)=DATEPART(DAY,GetDate()) ORDER BY b.FirstName   
